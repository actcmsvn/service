...
namespace ACTCMS\Service\Repositories;
...
class InstallRepository
{
    ...
    public function getPreRequisite()
    {
        ...
        $server[] = $this->check($this->my_version_compare(phpversion(), config('spondonit.php_version', '8.2.0'), '>='),'Current Version ' . phpversion(), sprintf('Min PHP version ' . config('spondonit.php_version', '7.2.0') . ' (%s)', 'Current PHP Version ' . phpversion()), true);
